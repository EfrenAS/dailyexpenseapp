...
export class BillController {
  getAllBills(req: Request, res: Response) {
    res.json({
  ...
  getBillById(req: Request, res: Response) {
    // TODO: Implement code for Get All Users of DB
    res.json({
  ...
  createBill(req: Request, res: Response) {
  ...
  updateBillById(req: Request, res: Response) {
  ...
  deleteBillById(req: Request, res: Response) {
